...
featured: true
featuredImage: "https://mccallister.dev/content/images/size/w960/2025/07/CleanShot-2025-07-22-at-10.51.34@2x-1.png"
...
The built-in `fish_config` command launches a web UI for managing themes, prompts, and variables, making customization accessible regardless of technical experience level.
...
However, macOS security restrictions typically produce a "non-standard shell" message. To resolve this, add Fish to the allowed shells list:
